...
public class NaverSearchAPI extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) 
		...
		//애플리케이션 클라이언트 아이디값"
		String clientId = "9GnH4BGeR8HEcs1dE23P";
		//애플리케이션 클라이언트 시크릿값"
        String clientSecret = "y8HYqcAUZb";
        ...
        try {
            ...
            start = URLEncoder.encode(startNum, "UTF-8");
        ...
        // json 결과
        String apiURL = 
        		"https://openapi.naver.com/v1/search/blog?query=" + text + "&display=20" + "&start=" + start;
        // xml 결과
        /*
        String apiURL = 
